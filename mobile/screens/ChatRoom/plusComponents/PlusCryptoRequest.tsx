...
export function PlusCryptoRequest() {
    ...
    return (
        <>
            <PlusItem onPress={openSendCryptoModal}>
                <PlusItem.Icon IconLib={FontAwesome6} name="money-bill-wave" />
                <PlusItem.Title title="Request Crypto" />
            </PlusItem>
            <SendCryptoRequestModal ref={sendCryptoModalRef} />
        </>
    );
}
...
const SendCryptoRequestModal = forwardRef((props: Props, ref: any) => {
